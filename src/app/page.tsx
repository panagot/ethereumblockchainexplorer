            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400 text-sm">
                  The Best Ethereum Blockchain Explorer - Easy to Read Transaction Analysis
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-600 dark:text-slate-400">
                <li>• Real-time MEV detection & analysis</li>
                <li>• Interactive transaction flow visualization</li>
                <li>• Educational content & explanations</li>
                <li>• Balance change tracking with USD values</li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-600 dark:text-slate-400">
                ...
                <li>• Advanced MEV detection algorithms</li>
              </ul>
            </div>
            <div>
          ...
          <div className="border-t border-slate-200 dark:border-slate-700 pt-4">
            <div className="text-center">
              ...
              <div className="flex items-center justify-center gap-4 text-xs text-slate-500 dark:text-slate-500">
                ...
                <span>•</span>
                <span>The Best Ethereum Blockchain Explorer</span>
                <span>•</span>
                <span>Easy to Read Transaction Analysis</span>
              </div>
            </div>
          </div>
        </div>
